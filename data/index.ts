...
},
{
    ...
    description: "As a whole, we are all passionate and dedicated to pushing the boundaries of technology, so we dont die ourselves down to a specific tech stack, as new things come out, we try it all!",
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
...
export const projects = [
  {
    id: 1,
    title: "Cojovi Digital | Cojovi.com",
    des: "Explore the wonders of custom ai integrations to automated workflows. We use Your vision, and our digital craftsmanship to enhanced your digital presence.",
    img: "/p1.png",
  ...
  {
    id: 3,
    title: "Beefthroat Apparel - Bold, Witty, Slightly Naughty Tees! ",
    des: "Ever been told your style is 'too much'? We at Beefthroat encourage you to embrace it! Your clothes are your shout-out to the world about who you are. Our apparel? It's not just clothing; it's a conversation starter.",
    img: "/p3.png",
    iconLists: ["/re.svg", "/tail.svg", "/ts.svg", "/three.svg", "/c.svg"],
    link: "/www.beefthroat.com",
  },
  {
    id: 4,
    title: "Cojovi Sport Footwear - Shoes of the future",
    des: "I got contracted to make a website for a shoe manufacturer, and in doing so i made a few for them to choose form, they didnt chose this one and i liked it too much to just let it sit, so i AI generated some shoes for all the filler images, lol",
    img: "/p4.png",
    iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "/three.svg", "/gsap.svg"],
    link: "/kicks.cojovi.com",
  },
];
